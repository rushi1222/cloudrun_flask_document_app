...
def download():
    ...
    buf.seek(0)
    return jsonify(
        {"b64": base64.b64encode(buf.read()).decode(), "fileName": fname}
    )

# ─────────────────── run server ──────────────────────────────────────────
if __name__ == "__main__":
    print("🚀  backend running  http://0.0.0.0:5050")
